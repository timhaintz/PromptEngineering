...
export default async function SemanticAnalysisPage() {
  ...
  <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="surface-card p-6">
            <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4 heat-2">
          ...
          <div className="surface-card p-6">
            <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4 heat-3">
              <svg className="w-6 h-6 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="surface-card p-6">
            <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4 heat-4">
              <svg className="w-6 h-6 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Suspense fallback={
          <div className="surface-card p-8">
            <div className="flex justify-center items-center h-32">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 spinner-accent"></div>
              <span className="ml-3 text-muted">Loading semantic analysis...</span>
            </div>
          </div>
        }>
  ...
  <div className="surface-card p-6 mt-8">
    <h2 className="text-2xl font-semibold text-primary mb-4">How to Use This Analysis</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-medium text-secondary mb-2">🔍 Discover Patterns</h3>
              ...
              <h3 className="text-lg font-medium text-secondary mb-2">📊 Understand Changes</h3>
            ...
            <div>
              <h3 className="text-lg font-medium text-secondary mb-2">🎯 Filter Effectively</h3>
              <ul className="text-sm text-muted space-y-1 mb-4">
              ...
              <h3 className="text-lg font-medium text-secondary mb-2">🔬 Research Applications</h3>
              <ul className="text-sm text-muted space-y-1">
