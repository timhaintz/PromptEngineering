    ...
    <PageShell variant="wide" noContainer>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <div className="rounded-lg border border-amber-500/30 bg-amber-50 dark:bg-amber-950/20 px-4 py-3 text-sm text-amber-800 dark:text-amber-200" role="status">
          <strong>Preview:</strong> Results shown here use representative examples. Live semantic search using Azure OpenAI embeddings is planned for a future release.
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="mx-auto h-12 w-12 flex items-center justify-center surface-card border border-muted rounded-lg mb-4">
                <svg className="h-6 w-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                </svg>
              </div>
              <h3 className="text-lg font-medium text-primary mb-2">Describe Your Task</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-primary mb-2">Get Matched Patterns</h3>
              <p className="text-secondary text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-primary mb-2">Explore & Compare</h3>
              <p className="text-secondary text-sm">
