          ...
          <form method="get" className="bg-white rounded-lg p-3 shadow border flex flex-col md:flex-row md:items-end gap-3">
            <div className="flex flex-col">
              ...
              <input
                ...
                className="border border-gray-300 rounded px-2 py-1 text-sm w-56 bg-white text-gray-800 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400"
              />
            </div>
            <div className="flex flex-col">
        ...
        {activeBadges.length ? (
          <div className="mb-4 flex flex-wrap gap-2">
            {activeBadges.map((b, i) => (
              <Link key={i} href={b.removeHref || '/patterns'} className="inline-flex items-center gap-1 bg-white border rounded-full px-2 py-1 text-xs text-gray-700 hover:border-blue-300">
                <span>{b.label}</span>
